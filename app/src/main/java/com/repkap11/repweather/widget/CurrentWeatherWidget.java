...
public class CurrentWeatherWidget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        CharSequence widgetText = CurrentWeatherWidgetConfigureActivity.loadTitlePref(context, appWidgetId);
    ...
    public void onDeleted(Context context, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            CurrentWeatherWidgetConfigureActivity.deleteTitlePref(context, appWidgetId);
        }
    }
